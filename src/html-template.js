const generateHTML = teamData => {
    ...
    const generateManager = manager => {
        ...
        <div class='card' style="width: 18rem;">
            <div class='row bg-primary'>
                <div class='row'><h2 class='card-title'>${manager.getName()}</h2></div>
                <div class='row'><h5>
    ...
    const generateEngineer = engineer => {
        ...
        <div class='card' style="width: 18rem;">
            <div class='row bg-primary'>
                <div class='row'><h2 class='card-title'>${engineer.getName()}</h2></div>
                <div class='row'><h5>
    ...
    const generateIntern = intern => {
        ...
        <div class='card' style="width: 18rem;">
            <div class='row bg-primary'>
                <div class='row'><h2 class='card-title'>${intern.getName()}</h2></div>
                <div class='row'><h5>
...
module.exports = teamData => {
    ...
    <body>
        <header class="row text-center bg-danger">
            <h1>My Dev Team</h1>
        </header>
        <div class='container-fluid '>
            <div class='row justify-content-around overflow-hidden px-4 py-4 gy-4'>
